          ...
          <Carousel.Caption>
            <div className="carousel_text_container">
              ...
              <div>
                ...
                <p className="small_font font_main">{t("malay_modal_gatecrash")}</p>
                <h3 className="small_font font_main">{t("malay_modal_tea_time")}</h3>
                <p className="small_font font_main">{t("malay_modal_tea_p")}</p>
                <p className="small_font font_main mt_2">{t("malay_modal_tea_everyone")}</p>
                <p>
                  <a 
          ...
          <Carousel.Caption>
            <div className="carousel_text_container">
              ...
              <div>
                ...
                <p className="small_font font_main">{t("malay_modal_cocktail_p")}</p>
